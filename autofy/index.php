    ...
    <div class="container">
	    <div class="row">
		    <div class="w3-container w3-padding w3-hide-small">
			   <h2>
				    <span class="w3-yellow w3-padding margin-0">W</span>
					<span class="w3-black  w3-padding margin-0">i</span>
					<span class="w3-blue   w3-padding margin-0">d</span>
					<span class="w3-pink   w3-padding margin-0">a</span>
					<span class="w3-green  w3-padding margin-0">d</span>
					<?php
				...
				<br/>
				<span class="w3-text-white" >SAKLAR ONLINE .WIDAD</span>
			</div>
